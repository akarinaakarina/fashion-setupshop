class BuyAddress
  ...
  attr_accessor :token, :postal_code, :prefecture_id, :municipality, :address, :phone_number, :building_name, :user_id,
                :original_item_id
  ...
  def save
    buy = Buy.create(user_id: user_id, original_item_id: original_item_id)
