...
# 工夫したポイント
・個人の詳細ページがその人のお店のようになるように工夫しました。お店の名前をページに大きく表示させ、ショップのプロフィールとしてコンセプトやこだわりなどを表示させてここがどんなお店なのかを分かりやすくしました。  
・お気に入り登録機能をつけることで即決はできないが保留にしたい商品を後ですぐに振り返れるようにしました。  
・メッセージ機能を商品ごとにつけることでお店のオーナーの方と直接話ができたり、その商品の製作者本人と直接会話ができるようにしました。  
・パンくずリストをつけることにより画面の遷移をしやすくしました。その上で階層を作りすぎずショップの個人ページに遷移しやすいように作りました。  
・ビューはモノトーンでまとめ、商品が見やすく落ち着いたデザインにしました。
